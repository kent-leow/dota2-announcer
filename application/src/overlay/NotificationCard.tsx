...
export function NotificationCard({ eventName, offsetSeconds, happenTimeMs, gameTimeMs, status, align = 'right', fontSizeName = 16, fontSizeOffset = 13, iconSize = 24, icon }: NotificationCardProps) {
  return (
